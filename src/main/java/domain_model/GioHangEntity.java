...
public class GioHangEntity {
    ...
    public GioHangEntity(UUID id, String ma, Date ngayTao, Date ngayThanhToan, Integer tinhTrang, String tenNguoiNhan, String diaChi, String sdt, KhachHangEntity khachHangByIdKh, NhanVienEntity nhanVienByIdNv, List<GioHangChiTietEntity> listGHCT) {
        this.id = id;
        this.ma = ma;
